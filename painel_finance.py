...
# Função para plotar o gráfico de retorno simples
...
# Função para plotar o gráfico de retorno logarítmico
...
# Função para plotar o gráfico de retorno simples acumulado
...
# Função para plotar o gráfico de retorno logarítmico acumulado
...
# Função para plotar o gráfico de densidade de retorno simples
def plot_density_simple_return(data, title):
    fig = px.histogram(data, x='simple_return', nbins=50, title=title)
    st.plotly_chart(fig)

# Função para plotar o gráfico de densidade de retorno logarítmico
def plot_density_log_return(data, title):
    fig = px.histogram(data, x='log_return', nbins=50, title=title)
    st.plotly_chart(fig)

# Função para plotar o gráfico de retorno simples vs retorno logarítmico
...
if data.empty:
    ...
    # Verificar se a coluna 'Adj Close' está presente no DataFrame
    if 'Adj Close' not in data.columns:
